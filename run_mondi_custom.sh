...
python modi-python/src/run_mondi.py \
--image_path custom_image.txt \
--sparse_depth_path custom_depth.txt \
--intrinsics_path custom_intrinsic.txt \
...
--depth_model_restore_path modi-python/pretrained_models/void/mondi-void.pth \
